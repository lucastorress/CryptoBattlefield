...
function scene:create( event )
    ...
    local mazeShape = display.newLine( 15, 90, 15, 390 )
    mazeShape:append( 15, 90, 300, 90 )
    mazeShape:append( 15, 300, 300, 300 )
    mazeShape:setStrokeColor( 1, 0, 3, 1 )
    mazeShape.strokeWidth = 10
    mazeShapeGroup:insert( mazeShape )
    print(mazeShape)
    ...
    physics.start()
    physics.addBody( mazeShape, "static", {density=1.0} )
