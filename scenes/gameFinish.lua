...
function scene:create( event )
	...
	audio.stop( 2 )
	musicTrack = audio.loadStream( "ui/audio/happy_If_I_Had_a_Chicken.mp3")
	audio.play( musicTrack, { channel=3, loops=0 } )

    local background = display.newImageRect( sceneGroup, "ui/background_gamefinish.png", screenWidth*1.1, screenHeight*1.1 )
